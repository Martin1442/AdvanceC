...
namespace CSharpAdvanced_Class4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(m1.PriceWithCurrency("EUR"));
            Console.WriteLine("Discount price: {0}", m1.PriceWithCurrency("EUR"));
            Console.WriteLine("--------------------");
            #endregion
            ...
            //Console.WriteLine(m2.PriceWithCurrency("EUR"));
            Console.WriteLine("Discount price: {0}", m2.PriceWithCurrency("EUR"));
            Console.WriteLine("--------------------");
            #endregion
            ...
            //Console.WriteLine($"Price kaa zatebe {pc1.PriceWithCurrency("EUR")}");

            Console.WriteLine("Discount price: {0}", pc1.PriceWithCurrency("EUR"));
            Console.WriteLine("--------------------");
            #endregion
            Console.ReadLine();
        }
